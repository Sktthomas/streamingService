...
class StreamForm  extends React.Component {
    ...
    onSubmit = (formValues) => { //we receive the values of the form directly from the redux form as an object
        this.props.onSubmit(formValues); //when the user submits a valid form, a callback function is called
    }
...
export default reduxForm({
    form: 'streamForm', 
    validate: validate}) (StreamForm); //reduxForm returns a function, which is immediately called with StreamCreate